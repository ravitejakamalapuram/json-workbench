...
- [x] Structure Insights profiling panel (field type/presence/null/inconsistency), one-click JSON Schema inference, and a UI Diff panel producing navigable JSON Patch output
